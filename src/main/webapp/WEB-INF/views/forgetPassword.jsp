...
<head>
    ...
    <script type="text/javascript">
        function changge(){
            var img=document.getElementById("J_imgVcode");
            img.src=img.src+"?";
        }
    </script>
</head>
...
<div class="container4">
    <div class="register_box">
        ...
        <div class="security">
            ...
            <form action="/estore/FindLostPassword" method="post">
                <ul class="list">
                    <li>
                        <input id="J_euserName" class="long" name="txtUser" onfocus="javascript:if(this.value=='请输入用户名')this.value='';" value="请输入用户名" type="text" />
                    ...
                    <li>
                        ...
                        <span class="code">
    							<img id="J_imgVcode" title="点击更换验证码" src="/estore/AutoImage" onclick="this.src=this.src+'?'" alt="点击更换验证码" height="38" width="85"/>
    						</span>
                        <a id="J_vcodeImgBtn" class="more" href="javascript:void(0);" onclick="changge();">换一张</a>
