...
<div class="container4">
    <div class="register_box">
        ...
        <div class="security">
            ...
            <form action="/estore/UpdateUserInfo" method="post">
                <ul class="list">
                    <li>
                        <input id="J_euserName1" class="long" name="password" value="" type="text" />
                    ...
                    <li>
                        <input id="J_euserName" class="long" name="surepassword" value="" type="text" />
