...
Source Database       : estore2

Target Server Type    : MYSQL
Target Server Version : 50544
File Encoding         : 65001

Date: 2018-04-28 19:17:49
*/
...
CREATE TABLE `idempotency` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=gb2312 COMMENT='幂等表';

-- ----------------------------
-- Records of idempotency
-- ----------------------------
INSERT INTO `idempotency` VALUES ('57', 'createOrderLine81160');
INSERT INTO `idempotency` VALUES ('58', 'createUser90611');
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=gb2312 COMMENT='订单表';
...
CREATE TABLE `order_line` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=gb2312 COMMENT='购物车中的每一个项';

-- ----------------------------
-- Records of order_line
-- ----------------------------
INSERT INTO `order_line` VALUES ('4', '3', '3', '7', 'Paperback', '6', '660.00', '2018-04-24 14:48:47');
INSERT INTO `order_line` VALUES ('5', '3', '3', '1', 'Hardback', '3', '186.00', '2018-04-24 16:13:22');
INSERT INTO `order_line` VALUES ('6', '3', '4', '6', 'Hardback', '3', '264.00', '2018-04-24 23:07:23');
INSERT INTO `order_line` VALUES ('7', '3', '0', '2', 'Paperback', '2', '40.00', '2018-04-28 17:19:05');
...
CREATE TABLE `receiver` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=gb2312 COMMENT='收件人表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=gb2312 COMMENT='用户表';

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('10', 'hahaha', '1234', '北京', '');
