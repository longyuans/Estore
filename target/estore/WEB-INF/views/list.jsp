	...
	window.onload = function() {
		...
		for ( var i = 0; i < choose_prices.length; i++) {
			...
			click.onclick = function() {
				...
				var ajax = null;
				var url = "/estore/listServlet?priceRank=" + this.innerHTML;
				//创建ajax对象
				...
				$(showTag)
						.html(
								"<li><span class='search_key'>出版社：</span> <span class='search_val'>"
										...
										+ "</span> <span onclick='deleteShowTag()' class='search_del'></span></li>");
				var ajax = null;
				var url = "/estore/listServlet?publishRank=" + this.innerHTML;
				console.log();
				//创建ajax对象
				if (window.ActiveXObject) {
					ajax = new ActiveXObject("Microsoft.XMLHTTP");
	...
	$(function() {
		...
		for ( var i = 0; i < OrderDiv.length; i++) {
			...
			click.onclick = function() {
				...
				var ajax = null;
				var url = "/estore/listServlet?CheckId=" + CheckId;
				//创建ajax对象
				if (window.ActiveXObject) {
					ajax = new ActiveXObject("Microsoft.XMLHTTP");
				}
...
<body>
	...
	<div class="container4">
				...
				<c:forEach items="${product}" var="product" begin="0" end="3">
					<li><img src="${product.images}">
						<div class="c4_b1_box_txt">
							...
							<h2>
								<a href="/estore/viewBookServlet?ProId=${product.getId()}">立即抢购</a>
							</h2>
						</div></li>
				</c:forEach>
			</ul>
		...
		<div class="c4_b2">
			<h1 class="c4_b2_x">
				<a>${ListName}&nbsp;&nbsp;></a> <span><a>${ListDetailName}</a> </span>
			</h1>
		...
		<div class="c4_b3">
			...
			<div>
				<ul class="c4_b3_search">
					...
					<li id="choose_price" class="c4_b3_vals" style="cursor: pointer;"><a>0-29</a><a>30-59</a>
				...
				<ul class="c4_b3_search">
					...
					<li class="c4_b3_vals" id="choose_publish" style="cursor: pointer;"><a>人民出版社</a>
		...
		<div class="c4_b4">
			<div class="c4_b4_x">
				...
				<div class="c4_b4_search">
					<input type="text" id="search2" value=""/><span onclick="search2()" style="cursor: pointer;">确认</span>
				</div>
						...
						<li class="c4_b5_c_box">
							...
							<div class="c4_b5_c_box_pic">
								<div class="c4b5_pic_view">
									<a
										href="/estore/viewBookServlet?ProName=${Book.getName()}&ProId=${Book.getId()}"><img
							...
							<div class="c4_b5_c_box_txt">
								...
								<h2>
									<a
										href="/estore/viewBookServlet?ProName=${Book.getName()}&ProId=${Book.getId()}">${Book.getName()}</a>
								</h2>
							</div> <!--购买等操作-->
							<div class="c4b5_el">
								<div class="c4b5_el_x">
							...
							<ul class="c4b5_option">
								<li class="shopcar_box"><span class="shopcar01"></span><a
									href="/estore/viewBookServlet?ProId=${Book.getId()}">加入购物车 </a></li>
							</ul></li>
						<%--
					<li class="c4_b5_c_box">
						 <!--图片-->
						<div class="c4_b5_c_box_pic">
							<div class="c4b5_pic_view">
								<a href="viewBook.html"><img src="images/list_p1.png">
								</a>
							</div>
						</div> <!--价钱-->
						<div class="c4_b5_c_box_txt">
							<h1>${listBook.get(1).getPrice }</h1>
							<h2>
								<a href="viewBook.html">${listBook.get(1).getName}</a>
							</h2>
						</div> <!--购买等操作-->
						<div class="c4b5_el">
							<div class="c4b5_el_x">
						...
						<ul class="c4b5_option">
							<li class="shopcar_box"><span class="shopcar01"></span><a
								href="javascript:void(0)" onclick="addShopCart('book_2')">加入购物车
							</a>
							</li>
						</ul></li>
					<li class="c4_b5_c_box">
						...
						<div class="c4_b5_c_box_pic">
							<div class="c4b5_pic_view">
								<a href="#"><img src="images/list_p1.png">
								</a>
							</div>
						</div> <!--价钱-->
						<div class="c4_b5_c_box_txt">
							<h1>${listBook.get(2).getPrice }</h1>
							<h2>
								<a href="viewBook.html">${listBook.get(2).getName}</a>
							</h2>
						</div> <!--购买等操作-->
						<div class="c4b5_el">
							<div class="c4b5_el_x">
						...
						<ul class="c4b5_option">
							<li class="shopcar_box"><span class="shopcar01"></span><a
								href="javascript:void(0)" onclick="addShopCart('book_3')">加入购物车
							</a>
							</li>
						</ul></li>
					<li class="c4_b5_c_box">
						...
						<div class="c4_b5_c_box_txt">
							<h1>${listBook.get(3).getPrice }</h1>
							<h2>
								<a href="viewBook.html">${listBook.get(3).getName}</a>
							</h2>
						</div> <!--购买等操作-->
						<div class="c4b5_el">
							<div class="c4b5_el_x">
						...
						<ul class="c4b5_option">
							<li class="shopcar_box"><span class="shopcar01"></span><a
								href="javascript:void(0)" onclick="addShopCart('book_4')">加入购物车
							</a>
							</li>
						</ul></li>
					<li class="c4_b5_c_box">
						...
						<div class="c4_b5_c_box_txt">
							<h1>${listBook.get(4).getPrice }</h1>
							<h2>
								<a href="viewBook.html">${listBook.get(4).getName}</a>
							</h2>
						</div> <!--购买等操作-->
						<div class="c4b5_el">
							<div class="c4b5_el_x">
						...
						<ul class="c4b5_option">
							<li class="shopcar_box"><span class="shopcar01"></span><a
								href="javascript:void(0)" onclick="addShopCart('book_5')">加入购物车
							</a></li>
						</ul></li>
						--%>
					</c:forEach>
