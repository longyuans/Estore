...
<body>
	...
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
                ...
                <li><a href="/estore/showShopCartServlet">我的订单<span class="jt_down"></span></a>|</li>
    ...
    <!--头部-->
    <div class="header3">
    	<a href="/estore/indexS"><img src="images/logo.png"  class="oneImg"></a>
	...
	<!-- 付款部分 -->
<form action="/estore/PayforServlet" method="post">
	<div style="width: 81%;margin-left:9.5%;height: 500px;background-color: #fffdf0;">
		...
		<div style="float:left; height:150px;width:99.7%;border:1px solid #f4f4f4">
			<div style="float: left;margin-top: 50px;margin-left: 18px"><input style="margin-top: 10px;" type="radio" name="radio" value="支付宝"></div> 
			<img style="float: left;margin-top: 30px;margin-left: 40px" src="images/zhifubao.png"> 
			<div style="float:left;margin-left:60px;margin-top: 58px"><p>支付宝 </p></div>
		</div>
		...
		<div class="submit">
    			<span style="margin-right: 11%">应付金额：<font>¥${allMoney}</font><input style="float: right;width: 100px;height: 40px;background-color: red;font-size: 20px;color: #fff;margin-top:5px;margin-right: 10%;"
