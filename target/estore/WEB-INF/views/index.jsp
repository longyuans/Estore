...
<div class="container3">
    <div class="c3_b1">
        <div class="c3_b1_left">
            <form action="/Book/booklistServlet" method="get">
                <dl>
                    <c:forEach items="${list}" var="list">
                        <dd>
                            <h1>
                            ...
                            <p>
                                <c:forEach items="${list.cate_detail}" var="detail">
                                    <a
                                            href="/Book/booklistServlet?cate_detailName=${detail.name}&cate_detailId=${detail.id}">${detail.name}</a>
                                </c:forEach>
                            </p>
                        </dd>
                    </c:forEach>
        ...
        <div class="c3_b1_center">
            ...
            <div class="c3_b1_c_bottom">
                <form action="/Book/viewBookServlet" method="get">
                    <ul>
