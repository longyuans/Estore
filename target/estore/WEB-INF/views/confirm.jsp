...
<script type="text/javascript">
	...
	var s="/estore/deleteReceiverServlet?ReceiverId="+ReceiverId;
		window.location=s;
	}
</script>
</head>
<body>
	...
	<!--中间复杂部分-->
	<form action="/estore/receiverServlet" method="get">
		<div class="content">
			<div class="contentCenter">
				...
				<p class="singleP">
					<b>送货清单</b><span><a href="/estore/showShopCartServlet">返回修改购物车</a> </span>
				</p>
				<div class="bigDiv">
					<div class="twoDiv">
						<b>商家：briup自营</b>
						<ul class="oneUL">
							<c:forEach items="${OrdPro}" var="OrdPro">
								<li><img src="${OrdPro.getProduct().getImages()}"
									...
									<p>
										<img src="images/sureLogo_14.png" alt=""><span>${OrdPro.getProduct().getServiceTh()}</span>
									</p></li>
				...
				<div class="submit">
					<span>应付金额：<font>¥ ${confirmSumPrice}</font> <input
						...
						style="width: 120px;height: 40px;border: none;background-color: red;margin-left: 60px;cursor: pointer;" />
					</span>
				</div>
			</div>
		</div>
